...
<1> The next section will show that the annotation will actually be {e1container}, representing the combination of {e1immutable} and {container}.
...
<<abstract-methods>> and <<immutable-content>>.
