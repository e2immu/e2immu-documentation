...
* All primitive types are level 2 immutable.
* Fields whose type is an unbound type parameters are level 2 immutable, as this type parameter could be substituted by `java.lang.Object`, which is level 2 immutable.
